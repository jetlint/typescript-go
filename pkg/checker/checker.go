...
const (
	...
	KindArrayType                   = Kind(ast.KindArrayType)
	KindTupleType                   = Kind(ast.KindTupleType)
	KindOptionalType                = Kind(ast.KindOptionalType)
	KindRestType                    = Kind(ast.KindRestType)
	KindConditionalType             = Kind(ast.KindConditionalType)
	KindInferType                   = Kind(ast.KindInferType)
	KindTypeOperator                = Kind(ast.KindTypeOperator)
	KindIndexedAccessType           = Kind(ast.KindIndexedAccessType)
	...
	KindBreakStatement           = Kind(ast.KindBreakStatement)
	KindContinueStatement        = Kind(ast.KindContinueStatement)
	KindLabeledStatement         = Kind(ast.KindLabeledStatement)
	...
	KindJsxElement               = Kind(ast.KindJsxElement)
	KindJsxFragment              = Kind(ast.KindJsxFragment)
	KindClassStaticBlockDeclaration = Kind(ast.KindClassStaticBlockDeclaration)
	KindMetaProperty             = Kind(ast.KindMetaProperty)
